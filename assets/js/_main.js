...
var toggle_category = function(cat) {
...
for (i = 0; i < x.length; i++) {
    ...
    if ((selected_categories.length > 0) && (selected_categories.some(val => !arr.includes(val)))) {
...
var w3AddClass = function (element, name) {
    var i, arr1, arr2;
...
var w3RemoveClass = function (element, name) {
    var i, arr1, arr2;
    arr1 = element.className.split(" ");
    arr2 = name.split(" ");
    for (i = 0; i < arr2.length; i++) {
...
var toggleActiveButton = function(el) {
